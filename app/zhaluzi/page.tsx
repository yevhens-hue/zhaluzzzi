...
export const metadata: Metadata = {
  title: 'Жалюзі на вікна (горизонтальні алюмінієві, вертикальні тканинні) — м. Дніпро',
  description:
    'Виготовлення та продаж жалюзі у м. Дніпро: алюмінієві горизонтальні 25 мм та тканинні вертикальні 89/127 мм. Доступні ціни від виробника.',
  keywords: [
    'жалюзі дніпро',
    ...
    <>
      ...
      <Suspense fallback={<div className="py-12 text-center text-sm text-gray-500">Завантаження...</div>}>
        <CatalogView
          ...
          categoryTitle="Жалюзі (горизонтальні алюмінієві та вертикальні тканинні)"
        />
      </Suspense>
    </>
  );
