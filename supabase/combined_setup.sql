-- ==========================================================
-- COMPLETE SCHEMA MIGRATION FOR MANOV / ДНІПРО ЖАЛЮЗІ ТА РОЛЕТИ
-- Run this entire script in Supabase SQL Editor:
-- https://supabase.com/dashboard/project/kapkqziyceefxluxlvqc/sql/new
-- ==========================================================
...
-- 9. RLS Policies (Read & Write permissions)
