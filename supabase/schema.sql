...
CREATE TABLE IF NOT EXISTS products (
  ...
  destinations TEXT[] DEFAULT '{}', -- e.g. ['na-kuhnju', 'v-spalnju', 'na-balkon', 'v-ofis', 'v-detskuju']
  description TEXT,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  email TEXT,
  city TEXT NOT NULL,
  delivery_type TEXT NOT NULL, -- 'nova_poshta', 'courier', 'self'
  delivery_address TEXT NOT NULL,
  payment_method TEXT NOT NULL, -- 'card', 'cash_on_delivery', 'privat_parts', 'mono_parts'
  items JSONB NOT NULL,
  total_amount NUMERIC NOT NULL,
  comment TEXT,
  status TEXT DEFAULT 'new', -- 'new', 'processing', 'manufacturing', 'shipped', 'delivered', 'cancelled'
  created_at TIMESTAMPTZ DEFAULT now()
);
...
CREATE TABLE IF NOT EXISTS leads (
  ...
  lead_type TEXT DEFAULT 'one_click', -- 'one_click', 'callback', 'consultation'
...
-- Allow public read access to categories, products, and reviews
CREATE POLICY "Public Read Categories" ON categories FOR SELECT USING (true);
CREATE POLICY "Public Read Products" ON products FOR SELECT USING (true);
CREATE POLICY "Public Read Reviews" ON reviews FOR SELECT USING (true);

-- Allow public insert into orders and leads
